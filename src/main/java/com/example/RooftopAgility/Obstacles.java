...
public enum Obstacles {
    ...
    DRAY_WALL_TWO(new WorldPoint(3082, 3256, 3), new WorldPoint(3089, 3262, 3), WALL_11630),
    ...
    PRIF_TIGHTROPE(new WorldPoint(3254, 6102, 2), new WorldPoint(3259, 6112, 2), TIGHTROPE_36225),
